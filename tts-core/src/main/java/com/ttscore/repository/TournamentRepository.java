...
public interface TournamentRepository extends JpaRepository<Tournament, Integer> {
    ...
    @Query("SELECT new com.ttscore.dto.TournamentDTO(t.id, t.name, t.city, t.street, t.date, t.users.size, t.maxPlayers) FROM Tournament t")
    ...
    @Query("SELECT new com.ttscore.dto.TournamentDetailsDTO(t.name, t.date, t.organizer, t.description," +
            " t.users.size, t.city, t.street, t.maxPlayers) FROM Tournament t WHERE t.id = ?1")
